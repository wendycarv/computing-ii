...
void hangman(void)
{
    ...
    while (number_of_guesses > 0)
    {
        ...
        {
            get_new_key(key, family, generic_vector_at(dictionary[word_length], i), guess);
        ...
        get_new_key(key, family, generic_vector_at(dictionary[word_length], 0), guess); //why is it printing the possibilities
